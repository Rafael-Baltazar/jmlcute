 ...
 *
 * $Id: JMLPublicInvariantError,v 1.0 2010/09/17 14:45:03 henriquerebelo Exp $
 */
 ...
 */
public class JMLPublicInvariantError extends JMLInvariantError {

	/**
	 * Creates a new <code>JMLInvariantError</code> instance from the given assertion message error. 
	 */
	public JMLPublicInvariantError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLPublicInvariantError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLPublicInvariantError(Throwable cause) {
		super(cause);
	}
}
