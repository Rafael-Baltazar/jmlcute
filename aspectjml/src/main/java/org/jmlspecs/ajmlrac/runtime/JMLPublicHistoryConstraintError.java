 ...
 *
 * $Id: JMLPublicHistoryConstraintError,v 1.0 2010/09/17 14:45:14 henriquerebelo Exp $
 */
...
public class JMLPublicHistoryConstraintError extends JMLHistoryConstraintError {
	 ...
	 */
	public JMLPublicHistoryConstraintError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLPublicHistoryConstraintError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLPublicHistoryConstraintError(Throwable cause) {
		super(cause);
	}
}
