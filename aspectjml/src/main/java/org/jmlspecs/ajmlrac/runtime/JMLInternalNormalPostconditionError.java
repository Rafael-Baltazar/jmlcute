 ...
 *
 * $Id: JMLInternalNormalPostconditionError.java,v 1.0 2009/01/20 19:47:23 henriquerebelo Exp $
 */
...
public class JMLInternalNormalPostconditionError extends JMLNormalPostconditionError {
	 ...
	 */
	public JMLInternalNormalPostconditionError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLInternalNormalPostconditionError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLInternalNormalPostconditionError(Throwable cause) {
		super(cause);
	}
}
