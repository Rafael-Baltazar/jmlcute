 ...
 *
 * $Id: JMLHistoryConstraintError.java,v 1.0 2010/04/04 15:45:04 henriquerebelo Exp $
 */
...
public class JMLHistoryConstraintError extends JMLAssertionError {
	 ...
	 */
	public JMLHistoryConstraintError(String message) {
		super(message);
	}
	
	public JMLHistoryConstraintError(String message, String methodName) {
		super(message);
		this.methodName = methodName;
	}
	
	public JMLHistoryConstraintError(Throwable cause) {
		super(cause);
	}
