 ...
 *
 * $Id: JMLPrivateInvariantError,v 1.0 2010/09/17 14:45:03 henriquerebelo Exp $
 */
...
public class JMLPrivateInvariantError extends JMLInvariantError {
	 ...
	 */
	public JMLPrivateInvariantError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLPrivateInvariantError(Throwable cause) {
		super(cause);
	}
}
