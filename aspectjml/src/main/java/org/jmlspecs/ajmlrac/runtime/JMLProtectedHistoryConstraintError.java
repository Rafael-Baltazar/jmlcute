 ...
 *
 * $Id: JMLProtectedHistoryConstraintError,v 1.0 2010/09/17 14:45:14 henriquerebelo Exp $
 */
 ...
 */
public class JMLProtectedHistoryConstraintError extends JMLHistoryConstraintError {

	/**
	 * Creates a new <code>JMLConstraintError</code> instance from the given assertion message error. 
	 */
	public JMLProtectedHistoryConstraintError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLProtectedHistoryConstraintError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLProtectedHistoryConstraintError(Throwable cause) {
		super(cause);
	}
}
