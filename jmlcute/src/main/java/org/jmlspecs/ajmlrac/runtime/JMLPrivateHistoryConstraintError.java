 ...
 *
 * $Id: JMLPrivateHistoryConstraintError,v 1.0 2010/09/17 14:45:14 henriquerebelo Exp $
 */
 ...
 */
public class JMLPrivateHistoryConstraintError extends JMLHistoryConstraintError {

	/**
	 * Creates a new <code>JMLConstraintError</code> instance from the given assertion message error. 
	 */
	public JMLPrivateHistoryConstraintError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLPrivateHistoryConstraintError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLPrivateHistoryConstraintError(Throwable cause) {
		super(cause);
	}
}
