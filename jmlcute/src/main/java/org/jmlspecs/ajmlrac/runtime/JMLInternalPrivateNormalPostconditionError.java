 ...
 *
 * $Id: JMLInternalPrivateNormalPostconditionError,v 1.0 2010/09/17 14:07:23 henriquerebelo Exp $
 */
...
public class JMLInternalPrivateNormalPostconditionError extends JMLInternalNormalPostconditionError {
	 ...
	 */
	public JMLInternalPrivateNormalPostconditionError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLInternalPrivateNormalPostconditionError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLInternalPrivateNormalPostconditionError(Throwable cause) {
		super(cause);
	}
}
