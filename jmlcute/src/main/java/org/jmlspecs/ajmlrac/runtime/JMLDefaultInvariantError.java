 ...
 *
 * $Id: JMLDefaultInvariantError,v 1.0 2010/09/17 14:45:03 henriquerebelo Exp $
 */
...
public class JMLDefaultInvariantError extends JMLInvariantError {
	 ...
	 */
	public JMLDefaultInvariantError(String message) {
		super(message);
	}
     ...
     */
    public JMLDefaultInvariantError(String message, String methodName)
    {
        super(message, methodName);
    }
    
    public JMLDefaultInvariantError(Throwable cause) {
		super(cause);
	}
}
