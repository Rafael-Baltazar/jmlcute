 ...
 *
 * $Id: JMLProtectedInvariantError,v 1.0 2010/09/17 14:45:03 henriquerebelo Exp $
 */
 ...
 */
public class JMLProtectedInvariantError extends JMLInvariantError {

	/**
	 * Creates a new <code>JMLInvariantError</code> instance from the given assertion message error. 
	 */
	public JMLProtectedInvariantError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLProtectedInvariantError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLProtectedInvariantError(Throwable cause) {
		super(cause);
	}
}
