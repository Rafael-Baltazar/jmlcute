 ...
 *
 * $Id: JMLInternalPublicNormalPostconditionError,v 1.0 2010/09/17 14:07:23 henriquerebelo Exp $
 */
 ...
 */
public class JMLInternalPublicNormalPostconditionError extends JMLInternalNormalPostconditionError {

	/**
	 * Creates a new instance from the given assertion message error. 
	 */
	public JMLInternalPublicNormalPostconditionError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLInternalPublicNormalPostconditionError(String message, String methodName)
	{
		super(message, methodName);
	}
	
	public JMLInternalPublicNormalPostconditionError(Throwable cause) {
		super(cause);
	}
}
